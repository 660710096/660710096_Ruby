...
* Ruby ใช้ระบบ Dynamic Typing ที่ยืดหยุ่นสูง ทำให้คุณไม่ต้องระบุชนิดตัวแปรและสามารถใช้ตัวดำเนินการอย่าง `+=` เพื่อคำนวณหรือต่อสตริงได้อย่างเป็นธรรมชาติ และ Operator บางตัวเป็นเพียงเมธอดที่สามารถ Overload ได้ ทำให้มีความสามารถในการปรับแต่งได้มากกว่า
...
* Ruby ใช้ Dynamic Typing ที่ยืดหยุ่นกว่า คุณจึงไม่ต้องระบุชนิดตัวแปรและสามารถใช้ตัวดำเนินการอย่าง `+=` เพื่อคำนวณหรือต่อสตริงได้อย่างเป็นธรรมชาติ และ Operator บางตัวเป็นเพียงเมธอดที่สามารถ Overload ได้ ทำให้มีความสามารถในการปรับแต่งได้มากกว่า
